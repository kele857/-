<template>
	...
	<view class='all'>
		...
		<view style="position: absolute;bottom: 260upx;width: 100%;">
			<!-- <view @click="clickSignUp(today,1)" :class="[active ? 'qdao' : 'active' ]">
				 <view style="margin: auto;">
					签到
				 </view>
			</view> -->
			
			<view :class="[!active ? 'qdao' : 'active' ]">
				 <view style="margin: auto;font-size: 32upx;">
					已签到
				 </view>
			</view>
		</view>
